				...
				<div class="column is-one-third action-buttons d-print-none" v-if="canWrite || isModal">
					<template v-if="canWrite">
						...
						>
							...
							<span class="padding20-right">{{ task.done ? $t('task.detail.undone') : $t('task.detail.done') }}</span>
						</x-button>
						...
						<x-button
							...
							v-shortcut="'l'"
						>
						<span class="padding20-right">{{ $t('task.detail.actions.label') }} </span>
						...
						<x-button
							...
							v-shortcut="'p'"
						>
						<span class="padding20-right"> {{ $t('task.detail.actions.priority') }} </span>
						...
						<x-button
							...
							icon="percent"
						>
						<span class="padding20-right"> 	{{ $t('task.detail.actions.percentDone') }} </span>
						...
						<x-button
							...
							v-shortcut="'c'"
						>
						<span class="padding20-right"> {{ $t('task.detail.actions.color') }}</span>
						...
						>
							...
							<span class="padding20-right"> 	{{ $t('task.detail.actions.assign') }}</span>
						...
						<x-button
							...
							icon="paperclip"
							v-shortcut="'f'"
						>	<span class="padding20-right"> {{ $t('task.detail.actions.attachments') }} </span> 
						...
						<x-button
							...
							v-shortcut="'r'"
						>
						<span class="padding20-right"> {{ $t('task.detail.actions.relatedTasks') }} </span> 
						...
						<x-button
							...
							v-shortcut="'m'"
						>
						<span class="padding20-right"> {{ $t('task.detail.actions.moveProject') }} </span> 
						...
						<x-button
							...
							v-shortcut="'d'"
						>
						<span class="padding20-right"> 	{{ $t('task.detail.actions.dueDate') }} </span> 
						...
						<x-button
							...
							icon="play"
						>
						<span class="padding20-right"> {{ $t('task.detail.actions.startDate') }} </span> 
						...
						<x-button
							...
							icon="stop"
						>
						<span class="padding20-right"> {{ $t('task.detail.actions.endDate') }} </span> 
						...
						<x-button
							...
							:icon="['far', 'clock']"
							v-shortcut="'Alt+r'"
						>	<span class="padding20-right">{{ $t('task.detail.actions.reminders') }}</span> 
						...
						<x-button
							...
							icon="history"
						>
						<span class="padding20-right">{{ $t('task.detail.actions.repeatAfter')}} </span> 
						</x-button>
						<x-button
						...
						>	<span class="padding20-right">	{{ $t('task.detail.actions.delete') }}</span> 
