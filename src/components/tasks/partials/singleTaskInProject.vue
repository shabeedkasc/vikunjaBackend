	...
	<div>
		...
		<fancycheckbox 
			...
			<span class="padding-right10">
				...
				>
				<span class="padding-right10"> 	{{ project.title }}</span>
				</router-link>
				...
				>
						...
						<span class="padding-right10"> 	{{ task.title }}</span>
				</router-link>
			</span>

				<labels
					v-if="task.labels.length > 0"
					class="labels ml-2 mr-1 padding-right10"
					:labels="task.labels"
				/>
				...
				<span class="project-task-icon padding-right10" v-if="task.description">
					<icon icon="align-left"/>
				</span>
				<span class="project-task-icon padding-right10" v-if="task.repeatAfter.amount > 0">
					<icon icon="history"/>
				</span>
			</span>
